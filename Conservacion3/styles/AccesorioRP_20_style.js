...
function categories_AccesorioRP_20(feature, value, size, resolution, labelText,
        ...
        image: new ol.style.RegularShape({radius: 4.070000000000002 + size, points: 4,
...
case '25':
                    return [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 4.1800000000000015 + size, points: 3,
...
default:
                    return [ new ol.style.Style({
        image: new ol.style.Circle({radius: 2.970000000000001 + size,
